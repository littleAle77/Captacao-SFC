...
import ProtegerMercado from '../components/ProtegerMercado'
            ...
            <Card>
              <div style={{ textAlign: 'center' }}>
                ...
                <p style={{ color: 'rgba(255,255,255,0.6)' }}>
                  Seus dados e vídeo foram enviados para análise da
                  equipe de captação do clube. O envio de material
                  não garante convocação — entraremos em contato
                  caso haja interesse.
                </p>
              </div>
            </Card>
      ...
      <PageContainer>
        ...
        >
          <Card>
            ...
            >
              Envie seus dados e material com lances/jogadas para
              avaliação da equipe de captação do clube.
            </p>
            ...
            <label className="field-label">
              Já jogou pela seleção? *
            </label>

            <select
              className="field"
              value={jogosSelecao}
              onChange={(e) => setJogosSelecao(e.target.value)}
            >
              <option value="">Selecione</option>
            ...
            <label className="field-label">
              Já jogou pela equipe profissional? *
            </label>

            <select
              className="field"
              value={jogosProfissional}
              onChange={(e) => setJogosProfissional(e.target.value)}
            >
              <option value="">Selecione</option>
              <option value="sim">Sim</option>
              <option value="nao">Não</option>
            ...
            <input
              ...
              type="url"
              value={linkOgol}
              onChange={(e) => setLinkOgol(e.target.value)}
              placeholder="https://www.ogol.com.br/..."
            />
